...
vim.keymap.set("n", "<C-h><C-p>", function() harpoon:list():prev() end, { desc = "[H]arpoon Next File" })
vim.keymap.set("n", "<C-h><C-n>", function() harpoon:list():next() end, { desc = "[H]arpoon Previous File" })
