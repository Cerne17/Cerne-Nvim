...
wk.add({
	...
	{ "<leader>hx", function() harpoon:list():select(2) end, desc = "Second file", mode = {"n", "v"} },
	{ "<leader>hc", function() harpoon:list():select(3) end, desc = "Third file", mode = {"n", "v"} },
	{ "<leader>hv", function() harpoon:list():select(4) end, desc = "Fourth file", mode = {"n", "v"} },
